...
// //         <Sidebar />
// //       </div>
// //       <div className="max-w-3xl mx-auto bg-neutral-900  mt-11 p-11 rounded-lg shadow-lg border border-white-700 p-1">
...
// //     <p className="text-sm text-white-400 mt-2">Last Updated: 03-09-2024</p>
// //   </div>
// //   <button
...
import { Sidebar } from "@/components1/sidebar";
import Header from "@/components1/header";
import { OutputData } from "@editorjs/editorjs"; // Import OutputData from EditorJS
...
const AboutUs = () => {
  ...
  // Update handleEditorChange to accept OutputData instead of string
  const handleEditorChange = (updatedContent: OutputData) =>
